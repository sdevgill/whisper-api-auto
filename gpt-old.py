...
def process_text_with_gpt(text):
    ...
    for chunk in chunks:
        ...
        #         "content": (
        #             """
        #             Transform the following text into a concise and informative format suitable for a PowerPoint presentation, highlighting the key points.\n
        #             """
        #             f""" {chunk} """
        #         ),
        #     }
